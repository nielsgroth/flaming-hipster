 ...
 * 
 */
@WebServiceClient(name = "StatServerService", targetNamespace = "http://server.stat.gossip/", wsdlLocation = "http://192.168.1.3:8000/gossipStatServer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.1.3:8000/gossipStatServer?wsdl");
