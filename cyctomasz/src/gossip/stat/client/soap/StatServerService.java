 ...
 * 
 */
@WebServiceClient(name = "StatServerService", targetNamespace = "http://server.stat.gossip/", wsdlLocation = "http://172.16.241.62:8000/gossipStatServer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://172.16.241.62:8000/gossipStatServer?wsdl");
