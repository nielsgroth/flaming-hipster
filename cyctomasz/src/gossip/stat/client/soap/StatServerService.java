 ...
 * 
 */
@WebServiceClient(name = "StatServerService", targetNamespace = "http://server.stat.gossip/", wsdlLocation = "http://192.168.1.4:8000/gossipStatServer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.1.4:8000/gossipStatServer?wsdl");
