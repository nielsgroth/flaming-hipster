...
public class NeighborCache {
    ...
    List<Neighbor> buildRequestList(int shuffleId) {
        ...
        while (subset.size() < leff && i < neighbors.size()) { // TODO i < neighbor.size �berfl�ssig
     ...
     * @param in
     */
    // TODO �berlegungen zum Alter siehe Notes
    ...
    private static void removeDuplicates(List<Neighbor> in) {
        ...
        for (Neighbor n : in) {
            Neighbor.CompareNeighbor cn = new Neighbor.CompareNeighbor(n); //TODO �berfl�ssig
